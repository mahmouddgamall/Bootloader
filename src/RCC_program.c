...
STD_ERROR RCC_RestAPB1_Peripheral   (u32 RCC_APB1RSTR )
{
	STD_ERROR LocalError=OK;
	 if(RCC_APB1RSTR>=0x40000000)
	 {
	   LocalError=NOT_VALID_INPUTS;
	 }
	else
	{
	  RCC->APB1RSTR |=RCC_APB1RSTR;
	}
	  return LocalError;
}

STD_ERROR RCC_RestAPB2_Peripheral   (u32 RCC_APB2RSTR )
{
	  STD_ERROR LocalError=OK;
	 if(RCC_APB2RSTR>=0x400000)
	 {
	   LocalError=NOT_VALID_INPUTS;
	 }
	else
	{
	  RCC->APB2RSTR |=RCC_APB2RSTR;
	}
	  return LocalError;
}
