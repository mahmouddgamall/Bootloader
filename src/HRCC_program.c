...
#define ALL_PERIPHERAL_APB1	0x3EFEC9FF
#define ALL_PERIPHERAL_APB2	0x0038FFFF
...
{
	STD_ERROR LocalError=OK;
	u32 Local=HRCC_RST & 0xC0000000;
	if(Local== 0x40000000)/*APB1*/
	{
		RCC_RestAPB1_Peripheral(HRCC_RST&0x3FFFFFFF);
	}
	else if(Local ==0x80000000)/*APB2*/
	{
		RCC_RestAPB2_Peripheral(HRCC_RST&0x3FFFFFFF);
	}
	else if(HRCC_RST ==HRCC_RST_ALL)/*APB1 && APB2 */
	{
		RCC_RestAPB1_Peripheral(ALL_PERIPHERAL_APB1);
		RCC_RestAPB2_Peripheral(ALL_PERIPHERAL_APB2);
	}
	else
	{
		LocalError=NOK;
